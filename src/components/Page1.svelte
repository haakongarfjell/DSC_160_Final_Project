...
<div>
    <h1>The car model</h1>
    <p>For simplicity, we assume that the friction F_f force is proportional to the velcity v of the car:</p>
    <p>F_f=k*v</p>
    <p>We also assume that the car is driving in a single gear with a constant propulsion force u</p>
      ...
      <svg width="500" height="250">
        ...
        <g>
            ...
            <!-- Arrow -->
            <path d="M 20 140 L 90 140" stroke="black" stroke-width="3"  /> <!--arrow pointing at windsheild-->
            ...
            <desc>
              <!-- Page2.svelte -->
              <script>
                  // You can add logic specific to Page2 here
              </script>
            </desc>
          </g>
